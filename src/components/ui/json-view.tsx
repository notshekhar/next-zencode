            ...
            if (!isTooLong) {
                return (
                    <div className="flex mr-1 rounded hover:bg-input/30">
                        ...
                        <pre className={typeStyleMap.string}>
                            &quot;{value}&quot;
                        </pre>
                    </div>
                );
            ...
            case "undefined":
                return (
                    <div className="flex items-center mr-1 rounded hover:bg-input/30">
                        ...
                        <span className={typeStyleMap.undefined}>
                            undefined
                        </span>
                    </div>
                );
            default:
                return (
                    <div className="flex items-center mr-1 rounded hover:bg-input/30">
                        ...
                        <span
                            className={
                                typeStyleMap[dataType] || typeStyleMap.default
                            }
                        >
